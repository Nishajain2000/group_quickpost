<?php 
    ...
    if(isset($_GET['edit'])){
        $id=$_GET['edit'];
        $edit_state=true;
        $rec = mysqli_query($db,"SELECT * FROM signup_tbl WHERE id=$id");
    ...
    <div class="signup__box">
        ...
        <form  method="post" action="editprofile_details.php">
            ...
            <div class="input-group">
                ...
                <input type="password" name="confirm_pass" placeholder="Password" id="cnfirm_pass" value="<?php echo $confirm_pass; ?>">
            </div>
