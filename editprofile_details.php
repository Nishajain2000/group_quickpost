<?php 
    ...
    if(isset($_POST['update'])){
        ...
        mysqli_query($db,"UPDATE signup_tbl SET user_name='$user_name',user_mail_id='$user_mail_id',confirm_pass='$confirm_pass',first_name='$first_name',last_name='$last_name' WHERE id=$id");
